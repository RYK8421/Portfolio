...
import { FaReact, FaMobileAlt, FaFire, FaBolt } from 'react-icons/fa';
                ...
                <div className="about-content">
                    <motion.div className="about-text" variants={itemVariants}>
                        ...
                        >
                            ...
                            with 2+ years of professional experience specializing in React.js, React Native Expo, and Electron.
                    ...
                    >
                        <div className="visual-container">
                            ...
                            <div className="floating-card card-3">
                                <div className="card-content">
                                    <span className="card-icon"><FaFire /></span>
                                    <span>Firebase</span>
                                </div>
                            </div>
